...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="mb-3 row d-flex justify-content-center">
            <textarea class="form-control" aria-label="With textarea" placeholder="Isi text deskripsi rumah tangga yang diinginkan" rows="6"></textarea>
        </div>
        <div class="mb-3 row d-flex justify-content-center">
            <button class="btn btn-submit" style="width: 15%">Rekomendasi</button>
        </div>
    </div>
</div>
@endsection